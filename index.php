    ...
    <ul class="slides">
      <li>
        ...
        <div class="caption center-align">
          ...
          <h6 class=" title_portal light grey-text text-lighten-3">COORDENA&Ccedil;&Atilde;O DE INOVA&Ccedil;&Atilde;O TECNOL&Oacute;GICA<br>Universidade Federal de Pelotas</h6>
        </div>
        </div>
      </li>
...
<ul class="tabs #536dfe indigo accent-2">
      ...
      <li class="tab col s2"><a href="#test7"><h6 class="areas">Guias e Normas</h6></a></li>
...
<h4 class="edt_chamamento_titulo">GUIAS E NORMAS</h4>
&nbsp;&nbsp;&nbsp;&nbsp;<h6 class="edt_chamamento_texto">Guias e Normas:
<div class="card-panel">
<h6>Guia de Transferência de Tecnologia
<a href="edital/guia.pdf">   Guia de Transferência de Tecnologia</h6></a>

</div>
<h4 class="edt_chamamento_titulo">Resoluções</h4>
&nbsp;&nbsp;&nbsp;&nbsp;<h6 class="edt_chamamento_texto">Resoluções:
<div class="card-panel">
<h6>Resolução-nº-30.2018:
<a href="edital/30.2018.pdf" >Resolução-nº-30.2018</h6></a>
